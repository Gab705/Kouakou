...
void reponses(char *question){
    ...
    {
        printf("Kouakou: Je suis Kouakou, un ChatBot d%cvelopp%ce par Eloge Kohou.\n", e1(), e1());
        printf("\n");
    }
    ...
    else if (strstr(question, "les technologies et l'avenir") != NULL)
    {
        printf("C'est L'IA");
        printf("\n");
    }
    ...
    {
        printf("Kouakou: L'intelligence artificielle (IA) est un domaine de l'informatique qui vise %c\n", a2());
        printf("cr%cer des systemes informatiques capables d'executer des t%cches\n", e1(), a3());
        printf("qui n%cc%cssitent g%cn%cralement une intelligence humaine.\n", e1(), e1(), e1(), e1());
        printf("\n");
    }
    ...
    {
        printf("Laissons cette affaire la stp!\n", e1());
        printf("\n");
    }
